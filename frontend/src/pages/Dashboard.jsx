...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard page-enter">
      ...
      {loading ? (
        <div className="dash-loading"><span className="spinner" style={{ borderTopColor: "var(--accent)" }} /></div>
      ) : error ? (
                  ...
                  {stats.perUser.map((u) => (
                    <div key={u.id} className="workload-row">
                      ...
                      <div className="workload-bar-wrap">
                        <div className="workload-bar" style={{ width: `${Math.min((u.task_count / (stats.totalTasks || 1)) * 100, 100)}%` }} />
                      </div>
